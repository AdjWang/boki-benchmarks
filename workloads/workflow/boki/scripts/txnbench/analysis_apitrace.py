...
LOG_FN_SET += ['BeginTxn', 'AbortTxn', 'CommitTxn', 'DBOps', 'Overall', 'DBOp-dbread', 'DBOp-dbwrite',
               'Fn_readonly', 'Fn_writeonly', 'Fn_dbops']
...
def is_user_fn(fn_name):
    ...
    # return fn_name in ['BeginTxn', 'AbortTxn', 'CommitTxn', 'DBOps', 'Overall', 'DBOp-dbread', 'DBOp-dbwrite',
    #                    'Fn_readonly', 'Fn_writeonly', 'Fn_dbops']
    return False
...
if __name__ == '__main__':
    ...
    def __extract_get_query_ratio(entry):
        ...
        # dbop_read_latency = line.latency_of('DBOp-dbread')
        # dbop_write_latency = line.latency_of('DBOp-dbwrite')
        # txn_read_latency = line.latency_of('Fn_readonly')
        # txn_write_latency = line.latency_of('Fn_writeonly')
        ...
        # return (dbop_read_latency, dbop_write_latency, txn_read_latency, txn_write_latency)
    ...
    # keys = ('dbop read latency', 'dbop write latency', 'txn read latency', 'txn write latency')
